<template>
    <div class="lottery_wraper">
        ...
        <div class="lottery_Content" :style="{width:lotterywidth[0]}">
          <div v-if="angle>0" id="turntable" v-bind:style="{ transform: 'rotate3d(0,0,1,'+angle+'deg)'}">
            <img   :src="contentBg">
            <div :class="'pri'+(index+1)" v-for='(i,index) in imgList' class="pri">
              <img :src="'http://photo.marketservice.cn'+i" alt="">
            </div>
          </div>
          <div v-else id="lottery_turntable">
            <img  id="" :src="contentBg">
            <div :class="'pri'+(index+1)" v-for='(i,index) in imgList' class="pri">
              <img :src="'http://photo.marketservice.cn'+i" alt="">
            </div>
          </div>
...
export default {
    ...
    computed: {
        difference () {
          if(this.prizeNo<10){
            return (this.prizeNo / this.prizeNum) * 360 - 720 / this.prizeNum / 2
          }else{
